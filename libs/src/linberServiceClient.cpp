...
linberServiceClient::linberServiceClient(char * service_uri, int service_uri_len){
	this->service_uri = service_uri;
	this->service_uri_len = service_uri_len;
	linber_init();
}

linberServiceClient::~linberServiceClient(){
	linber_exit();
}
...
--------------------------------------------------------------------------------------------------------*/
void linberServiceClient::linber_sendRequest(char *req, int req_len, char **res, int *res_len, bool blocking, int rel_deadline){
	int ret;
...
--------------------------------------------------------------------------------------------------------*/
void linberServiceClient::linber_create_shm(char **req, int req_len){
	key_t shm_key;
	int shm_id;
	static int low_id = 0;
	if((request_state == 0) && (request_shm_state == -1)){
...
Relative deadline is expressed as milliseconds.
--------------------------------------------------------------------------------------------------------*/
void linberServiceClient::linber_sendRequest_shm(char **res, int *res_len, bool blocking, int rel_deadline){
	unsigned long token;
...
--------------------------------------------------------------------------------------------------------*/
char* linberServiceClient::linber_get_response(){
	int ret;
...
--------------------------------------------------------------------------------------------------------*/
void linberServiceClient::linber_end_operation(){
